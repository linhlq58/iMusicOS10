 ...
 */
public class AlbumsDetailFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listSongs = db.getAllSongsByAlbumId(bundle.getString("album_id"));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_albums_detail, container, false);
